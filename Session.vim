...
silent! normal! zE
let &fdl = &fdl
let s:l = 97 - ((25 * winheight(0) + 21) / 43)
...
wincmd w
argglobal
if bufexists("cpu.h") | buffer cpu.h | else | edit cpu.h | endif
balt main.c
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 254 - ((30 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 254
...
silent! normal! zE
let &fdl = &fdl
let s:l = 61 - ((6 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 61
...
silent! normal! zE
let &fdl = &fdl
let s:l = 75 - ((12 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 75
...
wincmd w
argglobal
if bufexists("start.S") | buffer start.S | else | edit start.S | endif
balt program.c
setlocal keymap=
setlocal noarabic
setlocal autoindent
